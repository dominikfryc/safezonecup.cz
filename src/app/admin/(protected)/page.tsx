...
export default async function AdminDashboard() {
  ...
  if (!activeTournament) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-muted-foreground mb-6">Please create a tournament in the Tournaments tab.</p>
      </div>
    )
  }
  ...
  const goalsScored = matchesData?.reduce((acc, m) => acc + (m.home_score || 0) + (m.away_score || 0), 0) || 0
